...
function analyzeWatchlist(data) { 
    ...
    // ========================= 
    // If price crossed entry/target, but the setup structure remains highly valid
    ...
    let requiresNewPlan = isNewBaseValid; // Triggers new plan regardless of final AMA verdict
    const badges = []; 
