...
function analyzeNewScanMode(data) { 
    ...
    let momentumResult = { 
        ...
        participationTrend: "Not Available",
        relativeVolumeStatus: "Not Available", 
    ...
    const reasons = generateNewScanReasons({ 
        ...
        setupScore: setupResult.setupScore, 
        momentumScore: momentumResult.momentumScore, 
        momentumTrend: momentumResult.momentumTrend,
        participationTrend: momentumResult.participationTrend,
        relativeVolumeStatus: momentumResult.relativeVolumeStatus,
        weaknessDetected: momentumResult.weaknessDetected,
        ltp, ema20, ema50, rsi, advancedEnabled 
    }); 
...
function analyzeActiveTrade(data) { 
    ...
    const tradeResult = manageActiveTrade({ 
        ...data, 
        momentumScore: momentumResult.tradeMomentumScore,
        weaknessDetected: momentumResult.weaknessDetected 
    }); 
    
    const reasons = generateTradeReasons({ 
        tradeVerdict: tradeResult.tradeVerdict, 
        tradeHealth: tradeResult.tradeHealth, 
        pnlPercent: tradeResult.pnlPercent, 
        momentumHealth: momentumResult.momentumHealth,
        participationTrend: momentumResult.participationTrend, 
        weaknessDetected: momentumResult.weaknessDetected, 
        exhaustionDetected: momentumResult.exhaustionDetected, 
        ...data 
    }); 
    
    return { ...tradeResult, ...momentumResult, reasons }; 
}
