...
function validateBasicInputs(data) {
  ...
  if (
    ...
    return {
      ...
      message:
        "Please enter valid market data."
...
function validateWatchlistInputs(data) {
  ...
  if (
    ...
    safeNumber(previousTriggerLow) <= 0 ||

    safeNumber(previousTriggerHigh) <= 0 ||

    safeNumber(previousSL) <= 0
    ...
    return {
      ...
      message:
        "Previous Trigger Zone and Stop Loss are required."
  ...
  if (
    ...
    safeNumber(previousTriggerHigh) <=

    safeNumber(previousTriggerLow)
    ...
    return {
      ...
      message:
        "Trigger High must be greater than Trigger Low."
...
function validateActiveTradeInputs(data) {
  ...
  if (
    ...
    return {
      ...
      message:
        "Please complete all active trade inputs."
